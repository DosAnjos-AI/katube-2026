...
def construir_caminho_audio(nome_arquivo: str) -> str:
    """Constroi caminho relativo do audio baseado no ID do video."""
...
def validar_pasta_audios(id_video: str,
    ...
    Verificacoes realizadas:
      1. Pasta do video existe e e um diretorio
...
def processar_metadados(id_video: str) -> None:
    """
    ...
    Args:
        id_video: ID do video a processar (ex: 'B4RgpqJhoIo')
    """
    # --- Definir caminhos ---
    ...
    valido, mensagem_erro, arquivos_faltantes = validar_pasta_audios(id_video, nomes_segmentos)
    ...
    linhas_novas = [
        preparar_linha_csv(nome, dados_json[nome], colunas_finais)
